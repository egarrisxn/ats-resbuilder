...
export async function GET() {
  const resumeData = {
    contact: {
      ...
      phone: '+14071234567',
      email: 'rileym.dev@gmail.com',
      website: 'https://rileym.dev',
      github: 'https://github.com/rileymdev',
      linkedin: 'https://linkedin.com/in/riley-mx',
    },
    summary:
    ...
    experience: [
      ...
      },
      {
        ...
        company: 'Southpoint Distributors',
    ...
    education: [
      {
        ...
        field_of_study: 'Full Stack Web Development Boot Camp',
        dates: 'Mar 2023 - June 2023',
        institution: 'University of South Florida',
        location: 'Tampa, Florida, United States',
        summary: 'Credentials: https://badgr.com/public/assertions/xyZ3lmfQsPovNdJP3zv7YA',
      },
      {
        degree: 'Studied',
    ...
    projects: [
      {
        name: 'Loop Lane',
        github: 'https://github.com/rileymdev/looplane',
        description: [
      ...
      {
        name: 'AltWear',
        github: 'https://github.com/rileymdev/altwear',
        description: [
      ...
      {
        name: 'DevHues',
        github: 'https://github.com/rileymdev/devhues',
        description: [
      ...
      {
        name: 'FocusNode',
        github: 'https://github.com/rileymdev/focusnode',
        description: [
