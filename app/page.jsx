  ...
  return (
    <div className='mx-auto my-16 flex flex-col justify-center gap-8 p-4 lg:gap-12 lg:rounded-lg lg:border-2 lg:bg-slate-100 lg:px-12 xl:w-full xl:max-w-(--breakpoint-2xl) xl:flex-row xl:gap-8'>
      <section className='mx-auto my-4 flex flex-col gap-6 lg:pt-16 xl:w-full'>
        <div className='w-full max-w-[48rem] text-6xl leading-none font-black tracking-tighter sm:text-7xl 2xl:text-8xl'>
          ATS RESUME <span className='text-slate-500'>&</span>
          <br />
          COVER LETTER
        </div>
        <div className='w-full max-w-[34rem] pl-1 text-base leading-snug sm:max-w-[40rem] sm:text-lg 2xl:text-xl'>
        ...
        <div className='w-full max-w-[36rem] pb-2 pl-1 text-sm sm:max-w-[42rem] sm:text-base 2xl:text-lg'>
