    ...
    <>
      <section className='mx-auto my-4 flex max-w-[40rem] flex-col gap-4 px-4 sm:mt-24'>
        ...
        <h4 className='border-l-2 pl-1 leading-relaxed'>
          ...
          rendering your resume from Markdown, MDX, plain text, or fetching data from a JSON file or
          an API, this project illustrates the flexibility and creativity that can be applied to
          your development, each with unique advantages and challenges. Currently, users will be
          using <a href='https://pdf-lib.js.org/'>pdf-lib</a> to preview and save their PDF resume,
          and future enhancements will enable saving the resume as a doc/docx file.{' '}
